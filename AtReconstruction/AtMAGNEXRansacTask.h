#ifndef ATMAGNEXRANSACTASK_H
#define ATMAGNEXRANSACTASK_H
...
class AtMAGNEXRansacTask : public FairTask {
private:
   ...
   AtHitClusterEvent *fHitClusterEvent{};
...
public:
   ...
   ClassDefOverride(AtMAGNEXRansacTask, 1);
};
